...
def train_model(config=None):
    ...
    best_val_acc = 0.0
     ...
     for epoch in range(config.epochs):
        ...
        train_acc = total_acc / len(train_iter)
        ...
        logging.info(f'Accuracy on Validation set: {val_acc:.3f}')
        ...
        if val_acc > best_val_acc:
            ...
            logging.info(f'Save best model to {model_save_path}')
